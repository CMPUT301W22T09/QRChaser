//resource : developer.android.com/training/camerax/preview#java
...
//        );
            ...
            public void analyze(@NonNull ImageProxy image) {
                ...
                scanner.process(inputImage)
                        .addOnSuccessListener( barcodes -> {
                            if(!barcodes.isEmpty()) {
                                Barcode barcode = barcodes.get(0); //TODO:check if not null
        ...
        Camera camera = cameraProvider.bindToLifecycle((LifecycleOwner) this, cameraSelector, preview, qrAnalyser);
    ...
    //setup QRCode usecase to cameraX
